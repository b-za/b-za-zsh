# References
# https://github.com/zmre/pwzsh/blob/main/flake.nix
{
  description = "A shell to use to setup things on new systems before a proper config is in place";
  ...
  outputs = inputs @ { 
    ...
    in rec {
      ...
      apps.bbham-zsh = flake-utils.lib.mkApp {
        drv = packages.bbham-zsh;
        name = "bbham-zsh";
        exePath = "/bin/bbham-zsh";
      };
      packages.default = packages.bbham-zsh;
      apps.default = apps.bbham-zsh;
    });
}
